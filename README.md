...
Selain Postman, tersedia `run-tests.ps1` — suite end-to-end (**472 asersi**,
terakhir 472 PASS / 0 FAIL / 0 SKIP — tanpa SKIP bila `TEST_TERMINAL_ID/TOKEN` diset) mencakup auth, CRUD semua service, akademik,
